...
export function getBadgeTierStyles(tier?: BadgeTier) {
  const styles = {
    ...
    Adamantium: "border-violet-200/80 bg-violet-300/10 text-violet-50 shadow-[0_0_36px_rgba(167,139,250,0.35)]",
    SS: "border-violet-200/80 bg-violet-300/10 text-violet-50",
...
export function getTierAura(tier?: BadgeTier) {
  return {
    ...
    Adamantium: "from-white via-violet-200 to-emerald-300",
    SS: "from-white via-violet-200 to-emerald-300",
...
function getTierPromptStyle(tier: BadgeTier) {
  return {
    ...
    Adamantium: "adamantium metal, violet and emerald glow, ultimate endurance emblem",
    SS: "adamantium metal, violet and emerald glow, ultimate endurance emblem",
