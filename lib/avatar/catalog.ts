...
function layerShape(category: AvatarCategory, slug: string, accent: string) {
  const defaults: Record<AvatarCategory, string> = {
    ...
    skin_tone: `<path d='M31 160v-28q5-25 36-25l13 14 13-14q31 0 36 25v28z' fill='${accent}'/><path d='M48 160v-29q4-18 19-22l13 15 13-15q15 4 19 22v29z' fill='#e2e8f0'/><path d='M62 112l18 12 18-12' fill='none' stroke='#cbd5e1' stroke-width='3' stroke-linecap='round' stroke-linejoin='round'/><circle cx='38' cy='75' r='10' fill='${accent}'/><circle cx='122' cy='75' r='10' fill='${accent}'/><rect x='67' y='101' width='26' height='28' rx='10' fill='${accent}'/><circle cx='80' cy='72' r='43' fill='${accent}'/>`,
