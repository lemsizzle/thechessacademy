...
export function evaluateLichessPuzzleQuest(studentId: string, quest: Quest, window: QuestWindow, activities: LichessQuestPuzzleActivity[], mode: "connected" | "mock"): LichessQuestProgress {
