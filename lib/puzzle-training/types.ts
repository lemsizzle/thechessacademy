...
export const puzzleThemeOptions: ReadonlyArray<{ id: PuzzleThemeSlug; name: string; description: string }> = [
  ...
  { id: "attraction", name: "Decoy", description: "Lure a piece onto a vulnerable square." },
  { id: "backRankMate", name: "Back-rank mate", description: "Exploit a king trapped behind its own pawns." },
  { id: "capturingDefender", name: "Removing the defender", description: "Capture the piece protecting your real target." },
  ...
  { id: "doubleCheck", name: "Double attack", description: "Create two attacks at once; these puzzles use double check." },
