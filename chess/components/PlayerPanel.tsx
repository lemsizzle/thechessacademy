...
export function PlayerPanel({ name, subtitle, clockMs, active, thinking, portrait }: { name: string; subtitle: string; clockMs: number | null; active: boolean; thinking?: boolean; portrait?: string }) {
  return (
