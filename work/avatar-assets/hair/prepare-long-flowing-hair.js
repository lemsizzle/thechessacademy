...
const source = "work/avatar-assets/hair/long-flowing-hair-source.png";
const output = "work/avatar-assets/hair/long-flowing-hair.png";
...
async function main() {
  ...
  const hair = await sharp(data, { raw: info })
    ...
    .resize({ height: 720, fit: "inside", kernel: sharp.kernel.lanczos3 })
    .png()
  ...
  // Keep all existing eye, eyebrow, and mouth cosmetics visible.
