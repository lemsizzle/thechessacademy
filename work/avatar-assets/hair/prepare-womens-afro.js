...
const source = "work/avatar-assets/hair/womens-afro-source.png";
const output = "work/avatar-assets/hair/womens-afro.png";
...
async function main() {
  ...
  const hair = await sharp(data, { raw: info })
    ...
    .resize({ height: 650, fit: "inside", kernel: sharp.kernel.lanczos3 })
    .png()
