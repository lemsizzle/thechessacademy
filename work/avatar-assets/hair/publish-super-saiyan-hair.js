...
const localPath = "work/avatar-assets/hair/super-saiyan-hair.png";
const bucket = "avatar-assets";
const objectPath = `hair/super-saiyan-hair-${version}.png`;
const item = {
  name: "Super Saiyan Hair",
  slug: "super-saiyan-hair",
  description: "Luminous golden transformation hair with a towering crown of sharply layered spikes.",
  category: "hair",
  rarity: "Epic",
  price: 100,
  layer_order: 30,
