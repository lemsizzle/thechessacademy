...
export default async function AdminLeaderboardPage() {
  ...
  return (
    <AppShell title="Teacher Leaderboard" subtitle="View class rankings from the teacher dashboard. Student links open the admin student editor." variant="admin">
      ...
      <LeaderboardBoard initialStudents={students.data} initialXpEvents={xpEvents.data} badges={badges.data} avatarItems={avatarDisplay.items} studentAvatars={avatarDisplay.avatars} survivalScores={survivalScores} starWarsScores={starWarsScores} linkMode="admin" />
    </AppShell>
  );
}
