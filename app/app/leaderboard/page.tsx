...
export default async function LeaderboardPage() {
  ...
  return (
    <AppShell title="Leaderboard" subtitle="Rankings by XP, with class filters for parents, students, and the teacher.">
      ...
      <LeaderboardBoard initialStudents={students.data} initialXpEvents={xpEvents.data} badges={badges.data} avatarItems={avatarDisplay.items} studentAvatars={avatarDisplay.avatars} survivalScores={survivalScores} />
    </AppShell>
  );
}
