...
// Reveal the existing registration entry points when public enrollment opens.
const SHOW_PUBLIC_REGISTRATION = false;
      ...
      <div className="mx-auto w-full max-w-3xl space-y-5">
        <Card className="p-6 sm:p-8">
          ...
          <p className="mt-4 max-w-2xl text-slate-300">
            Train, play, and grow your chess adventure. Log in with Lichess, or use the Academy username your teacher gave you.
          </p>
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <Button href="/api/auth/lichess/start">Log in with Lichess</Button>
            <Button href="/login" variant="secondary">Log in with Academy username</Button>
          </div>
          {SHOW_PUBLIC_REGISTRATION && <div className="mt-6 border-t border-white/10 pt-5">
